...
//////// [ Probe and Input Registers ] /////////////////////////////////////////////////////////////////////////
	...
	#define BATPIN PC5							// AVR pin 28 -battery test


//////// [ Internal Calculation Variables ] ////////////////////////////////////////////////////////////////////
	#define SMALL_CAP_VALUE 365						// 218  0xDA    Adjust for accuracy on big Caps with 750R, was 394
	#define LARGE_CAP_VALUE 208					// 167  0xA7    Adjust for accuracy, small Caps with 500K, was 283
	#define BAT_WEAK 650							// 930  0x03A2  7.7V weak battery, was 650
	#define BAT_DEAD 600							// 875  0x036B  7.2V dead Battery, was 600
	#define LARGE_R_VALUE 5000						// 4700
	#define SMALL_R_VALUE 750						// 680
	#define ASCII_1 49								// Ascii one.
	#define ASCII_0 48								// Ascii zero.
	#define NORMAL_CAP_TESTS 1						// Just do normal Cap test, compare to CapTestMode in k,, 2 to enable all
...
//////// [ Usfull Bit Control Defines ] ///////////////////////////////////////////////////////////////////////
	...
	#define SETBITMASKL(x,y) (x|1<<(y)) 
	#define CLEARBITMASKL(x,y) (x|0<<(y))
...
//////// [ Power and Regulator Control Defines ] //////////////////////////////////////////////////////////////////////
	...
	#define ON_PIN_REG 	PINC
	#define ON_PIN 		PORTC3 //PD6

	#define RST_DDR 	DDRD
	#define RST_PORT 	PORTD
	#define RST_PIN_REG PIND
	#define RST_PIN 	PORTD7
	
	//// Pin Control Defines ////////////////////////
	//POWER_ON() 	= Turn the regulator ON
	#define POWER_ON() 	ON_DDR = (1<<ON_PIN); SETBIT(ON_PORT,ON_PIN); SETBIT(RST_PORT,RST_PIN)
	...
	#define RESET_GET() CHECKBIT(RST_PIN_REG,RST_PIN)
